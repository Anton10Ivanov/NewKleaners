        ...
        <div className='max-w-2xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-lg text-gray-600 mb-8'>
              Your cleaning service has been successfully booked. You'll receive a confirmation
              email shortly.
            </p>
          </motion.div>
          ...
          <Card className='mb-8'>
            <CardHeader>
              ...
              <CardDescription>Your booking reference: {bookingId || 'N/A'}</CardDescription>
            </CardHeader>
          ...
          <div className='space-y-4'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <Button onClick={handleBackToHome} variant='outline' className='px-8'>
                Back to Home
              </Button>
