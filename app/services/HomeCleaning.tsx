...
import { ArrowRight, CheckCircle, Clock, Home, Shield, Star } from 'lucide-react';
          ...
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center space-y-6'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-3xl mx-auto'>
                Keep your home spotless with our reliable, professional cleaning services
              </p>
            </div>
          </UnifiedContainer>
        </section>
          ...
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-2xl mx-auto'>
                We&apos;re committed to providing the highest quality home cleaning services
              </p>
            </div>
        ...
        <section className='py-20'>
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center space-y-8'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-2xl mx-auto'>
                Book your home cleaning service today and experience the difference
              </p>
