...
import { ArrowRight, Building2, CheckCircle, Clock, Shield, Star } from 'lucide-react';
          ...
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center space-y-6'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-3xl mx-auto'>
                Maintain a pristine, professional workspace with our comprehensive office cleaning
                services
              </p>
            </div>
          </UnifiedContainer>
          ...
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-2xl mx-auto'>
                We&apos;re committed to providing the highest quality office cleaning services
              </p>
            </div>
        ...
        <section className='py-20'>
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center space-y-8'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-2xl mx-auto'>
                Book your office cleaning service today and experience the difference
              </p>
