...
import { ArrowRight, CheckCircle, Clock, Shield, Star, Truck } from 'lucide-react';
          ...
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center space-y-6'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-3xl mx-auto'>
                Make your move stress-free with our comprehensive move-in/move-out cleaning service
              </p>
            </div>
          </UnifiedContainer>
        </section>
          ...
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-2xl mx-auto'>
                We&apos;re committed to providing the highest quality move-in/move-out cleaning
                services
              </p>
            </div>
        ...
        <section className='py-20'>
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center space-y-8'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-2xl mx-auto'>
                Book your move-in/move-out cleaning service today and experience the difference
              </p>
