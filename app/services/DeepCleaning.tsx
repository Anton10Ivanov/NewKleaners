...
import { ArrowRight, CheckCircle, Clock, Shield, Sparkles, Star } from 'lucide-react';
          ...
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center space-y-6'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-3xl mx-auto'>
                Intensive cleaning for special occasions and thorough property maintenance
              </p>
            </div>
          </UnifiedContainer>
        </section>
          ...
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-2xl mx-auto'>
                We&apos;re committed to providing the highest quality deep cleaning services
              </p>
            </div>
