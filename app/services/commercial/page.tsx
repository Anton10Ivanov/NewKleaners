...
const services = [
  ...
  },
  {
    ...
    icon: Shield,
    features: ['Medical-grade disinfectants', 'HIPAA compliance', 'Sterile environments'],
    popular: false,
    color: 'bg-green-500',
  ...
  },
  {
    ...
    description: 'Child-safe cleaning for educational facilities',
    icon: Users,
    features: ['Child-safe products', 'Educational standards', 'Play area cleaning'],
    popular: false,
    color: 'bg-yellow-500',
    price: 'Starting at €149',
  },
  {
    ...
    description: 'Professional cleaning for care homes',
    icon: Wrench,
    features: ['Elderly-friendly approach', 'Medical compliance', 'Comfort maintenance'],
    popular: false,
    color: 'bg-purple-500',
  ...
  },
  {
    ...
    description: 'Event cleaning for trade shows and exhibitions',
    icon: Zap,
    features: ['Event-specific cleaning', 'Quick turnaround', 'Large venue expertise'],
    popular: false,
    color: 'bg-orange-500',
  ...
  },
  {
    ...
    description: 'Specialized cleaning for underground parking',
    icon: Building2,
    features: ['Concrete cleaning', 'Oil stain removal', 'Drainage maintenance'],
    popular: false,
    color: 'bg-gray-500',
          ...
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center space-y-6'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-3xl mx-auto'>
                Professional cleaning solutions for businesses, institutions, and commercial
                facilities
              </p>
            </div>
          </UnifiedContainer>
          ...
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-2xl mx-auto'>
                We&apos;re committed to providing the highest quality commercial cleaning services
              </p>
            </div>
        ...
        <section className='py-20'>
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center space-y-8'>
              ...
              <p className='text-xl text-oxford-blue-600 max-w-2xl mx-auto'>
                Book your commercial cleaning service today and experience the difference
              </p>
