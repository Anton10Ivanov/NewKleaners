        ...
        <UnifiedContainer size="xl" padding="lg">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <h2 className="text-2xl font-semibold text-oxford-blue mb-4">1. Information We Collect</h2>
              ...
              <h2 className="text-2xl font-semibold text-oxford-blue mb-4">2. How We Use Your Information</h2>
              <p className="text-gray-700 mb-6">
                We use the information we collect to provide, maintain, and improve our services, process transactions, and communicate with you.
              </p>

              <h2 className="text-2xl font-semibold text-oxford-blue mb-4">3. Information Sharing</h2>
              <p className="text-gray-700 mb-6">
              ...
              <p className="text-gray-700 mb-6">
                If you have any questions about this Privacy Policy, please contact us at privacy@kleaners.de
              </p>
            </div>
          </div>
        </UnifiedContainer>
