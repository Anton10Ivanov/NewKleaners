          ...
          <UnifiedContainer size="xl" padding="lg">
            <div className="text-center space-y-6">
              ...
              <p className="text-xl text-oxford-blue-600 max-w-3xl mx-auto">
                Join our network of professional cleaners and start earning money on your own schedule.
                Work when you want, where you want, and earn competitive rates.
              </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  ...
                  Here's what we look for in our cleaning providers:
                </p>
              ...
              <div className="bg-orange-peel/10 rounded-lg p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Join our team of professional cleaners and start earning money on your own schedule.
