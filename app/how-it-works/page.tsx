...
const steps = [
  {
    ...
    description:
      'Select the type of cleaning service you need - home, office, deep cleaning, or specialized services.',
    details:
      'Browse our comprehensive range of cleaning services and select the one that best fits your needs.',
  },
  {
    number: 2,
    icon: Calendar,
  ...
  },
  {
    ...
    details:
      "Sit back and enjoy your spotless space, knowing you're covered by our satisfaction guarantee.",
  },
];
        ...
        <section className='bg-gradient-to-br from-seasalt via-seasalt-50 to-orange-peel-50 py-20'>
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center space-y-6'>
              <h1 className='heading-responsive text-oxford-blue'>How It Works</h1>
              <p className='body-large text-oxford-blue-600 max-w-3xl mx-auto'>
                Getting your space cleaned has never been easier. Follow these simple steps to book
                  ...
                  <Card key={step.number} className='relative'>
                    <CardHeader className='text-center'>
                      <div className='relative mb-4'>
                        ...
                        <div className='absolute -top-2 -right-2 w-8 h-8 bg-oxford-blue text-white rounded-full flex items-center justify-center caption font-bold'>
                          {step.number}
                        </div>
                      </div>
                      <CardTitle className='heading-4'>{step.title}</CardTitle>
                      <CardDescription className='body-regular'>{step.description}</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className='body-small text-gray-600 text-center'>{step.details}</p>
                    </CardContent>
                  </Card>
                );
              })}
              ...
              {benefits.map((benefit, _index) => {
                ...
                return (
                  <div key={_index} className='text-center'>
                    ...
                    <h3 className='heading-4 text-oxford-blue mb-2'>{benefit.title}</h3>
        ...
        <section className='py-20'>
          <UnifiedContainer size='xl' padding='lg'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
              <div>
                <h2 className='heading-2 text-oxford-blue mb-6'>What Happens After You Book?</h2>
                <div className='space-y-6'>
                  ...
                  <div className='flex items-start space-x-4'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-600'>
                        We'll assign a qualified cleaner and send you their profile and contact
                        information.
                      </p>
                    </div>
                  </div>
                  <div className='flex items-start space-x-4'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-600'>
                        Your cleaner will contact you 24 hours before the service to confirm
                        details.
                      </p>
                    </div>
                  </div>
              ...
              <div className='bg-orange-peel/10 rounded-lg p-8'>
                <h3 className='heading-3 text-oxford-blue mb-4'>Ready to Get Started?</h3>
        ...
        <section className='bg-orange-peel py-20'>
          <UnifiedContainer size='xl' padding='lg'>
            <div className='text-center space-y-8'>
              <h2 className='heading-2 text-black'>Start Your Cleaning Journey Today</h2>
