          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            ...
            <div className='space-y-4'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-xl font-bold'>Kleaners</span>
              </div>
              ...
              <div className='flex space-x-4'>
                <a href='https://facebook.com/kleaners' target='_blank' rel='noopener noreferrer' className='text-seasalt/60 hover:text-orange-peel transition-colors' aria-label='Follow us on Facebook'>
                  <Facebook className='w-5 h-5' />
                </a>
                <a href='https://twitter.com/kleaners' target='_blank' rel='noopener noreferrer' className='text-seasalt/60 hover:text-orange-peel transition-colors' aria-label='Follow us on Twitter'>
                  <Twitter className='w-5 h-5' />
                </a>
                <a href='https://instagram.com/kleaners' target='_blank' rel='noopener noreferrer' className='text-seasalt/60 hover:text-orange-peel transition-colors' aria-label='Follow us on Instagram'>
                  <Instagram className='w-5 h-5' />
                </a>
                <a href='https://linkedin.com/company/kleaners' target='_blank' rel='noopener noreferrer' className='text-seasalt/60 hover:text-orange-peel transition-colors' aria-label='Follow us on LinkedIn'>
