...
export function CTA() {
  return (
    <section className='py-20 bg-gradient-to-br from-secondary-foreground to-secondary-foreground/80'>
      <UnifiedContainer size='xl' padding='lg'>
        <div className='text-center space-y-8'>
          <div className='space-y-4'>
            <h2 className='heading-2 text-secondary'>Ready to Experience Professional Cleaning?</h2>
            <p className='body-large text-secondary/80 max-w-2xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mt-16'>
            <Card className='bg-card/10 backdrop-blur-sm border-card/20 text-secondary'>
          ...
          <div className='mt-12 pt-8 border-t border-secondary/20'>
            <div className='flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8'>
              <div className='text-center'>
                ...
                <div className='text-sm text-secondary/80'>Happy Customers</div>
              </div>
              <div className='w-px h-8 bg-secondary/20 hidden md:block' />
              <div className='text-center'>
                <div className='text-2xl font-bold text-secondary'>500+</div>
                <div className='text-sm text-secondary/80'>Verified Providers</div>
              </div>
              <div className='w-px h-8 bg-secondary/20 hidden md:block' />
              <div className='text-center'>
                <div className='text-2xl font-bold text-secondary'>50,000+</div>
                <div className='text-sm text-secondary/80'>Services Completed</div>
              </div>
            </div>
          </div>
        </div>
