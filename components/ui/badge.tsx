...
const badgeVariants = cva(
  'inline-flex items-center rounded-full border px-2.5 py-0.5 caption font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        copper: 'border-transparent bg-copper text-copper-foreground hover:bg-copper/80',
      },
    },
    defaultVariants: {
      variant: 'default',
